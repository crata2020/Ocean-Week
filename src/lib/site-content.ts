...
export const scheduleOverview = [
  ...
  },
  {
    day: "DAY 3",
    date: "6월 10일(수)",
    title: "시상식 · 리더스서밋 · 온라인 컨퍼런스 · 극지시민강좌",
    items: [
  ...
  },
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        time: "14:00 - 15:30",
        capacity: 200,
        description: "북극항로 연관산업 발전 방안 논의 (현장/온라인 병행)",
      },
      {
        ...
        time: "16:00 - 17:30",
        capacity: 200,
        description: "북극항로시대 극지교육의 방향성 모색",
      },
      {
...
export const contentPages: Record<ContentSlug, ContentPage> = {
  intro: {
    ...
    sections: [
      ...
      {
        title: "6월 10일(수): 시상식 · 리더스서밋 · 온라인 컨퍼런스 · 극지시민강좌",
        body: [
          "오전에는 <대한민국해양지도자대상 시상식>이 먼저 진행됩니다. 해양관련 우수한 업적을 남긴 분들을 대상으로\n'지·산·학·연' 부문에서 각 한 명씩을 선정하여 상을 수여합니다.",
          "<해양산업리더스서밋>은 해양산업 관련 산·학·연 리더 100여 명을 초빙하여 개최됩니다. 상호 네트워크를 강화할 뿐 아니라, 전문가 초청 강연을 통해 산업의 미래를 함께 모의합니다.",
  ...
  events: {
    ...
    eyebrow: "Side Events",
    summary:
      "추진안에 포함된 부대행사는 대한민국해양지도자대상 시상식, 해양산업리더스서밋, 온라인 해양콘퍼런스로 구성되어 있습니다.",
    sections: [
      {
        title: "대한민국해양지도자대상",
        body: [
