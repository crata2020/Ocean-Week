    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "<블루카본의 잠재력과 탄소시장화 전략>: 중국 시안대학교의 천루전 교수와 인도 VNV 어드바이저리의 산딥 로이 초두리 대표, 서울대학교 김종성 교수, LG전자 김영석 실장, 한국해양수산개발원 정여진 박사 등을 비롯해 국내 전문가들이 참여해 글로벌 동향과 정책 방향을 공유하며, LG전자에서 개발한 신소재가 블루카본 시장에 어떻게 적용될 수 있을지에 대한 심도 있는 논의가 진행됩니다.",
          "<해양풍력 특별법 시대 개막 기회와 도전·미래전략>: 해상풍력 특별법 시행을 계기로 국내 에너지 산업은 새로운 전환점을 맞이하고 있습니다. 본 세션에서는 제도 변화가 산업 전반에 미칠 영향을 짚어보고, 해상풍력 확대를 위한 기회와 과제를 균형 있게 살펴봅니다. 국립한국해양대학교 이영호 교수가 좌장을 맡고, 한국풍력산업협회 최덕환 실장이 발제를 통해 정책 방향과 산업 전망을 제시합니다. 이어지는 토론에서는 각계 전문가들이 참여해 해상풍력 산업의 지속가능한 성장과 미래 전략을 심도 있게 논의할 예정입니다.",
        ],
      },
      {
  ...
  schedule: {
    ...
    sections: [
      ...
      },
      {
        title: "6월 8일(월)",
        body: [
          "오전에는 개회식 및 공연과 기관장 토크 콘서트가 진행되며, 토크 콘서트의 주제는 '해양수산부 이전과 해양수도 부산의 비전'입니다. 황종우 해양수산부 장관, 조승환 국회의원, 배상훈 국립부경대학교 총장, 류동근 국립한국해양대학교 총장, 김영재 부산연구원 원장, 최금식 선보패밀리그룹 회장이 참여 대상으로 제시되어 있습니다.",
