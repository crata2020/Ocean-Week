...
export const contentPages: Record<ContentSlug, ContentPage> = {
  ...
  schedule: {
    ...
    summary:
      "행사는 2026년 6월 8일(월)부터 6월 10일(수)까지 부산 벡스코 2전시관 320~324호에서 진행되며, 개회식부터 포럼, 시민강좌, 시상식, 온라인 콘퍼런스까지 3일 일정으로 구성됩니다.",
    sections: [
      {
        title: "행사장 및 운영 안내",
        body: [
  ...
  underwater: {
    ...
    summary:
      "바닷속에 감춰진 신비롭고 아름다운 생태계와 그 속에서 살아가는 생명체들의 순간을 기록한 전시입니다.",
    sections: [
      {
        title: "전시 소개",
        body: [
          "수중사진전은 일반인들이 쉽게 접하기 어려운 깊은 바닷속의 생생한 모습을 전달하여 해양 생태계의 중요성과 보존의 가치를 일깨우고자 기획되었습니다.",
          "화려한 산호초부터 거대 해양 생물까지, 렌즈를 통해 바라본 바다의 경이로운 풍경을 만나보실 수 있습니다.",
        ],
      },
    ],
  },
  polar: {
    ...
    summary:
      "남극과 북극, 지구의 끝에서 마주한 극한의 아름다움과 기후 위기의 현장을 담은 전시입니다.",
    sections: [
      {
        title: "전시 소개",
        body: [
          "극지사진전은 혹독한 환경 속에서도 끈질기게 이어지는 생명력과 함께, 온난화로 인해 빠르게 변화하고 있는 빙하와 극지 생태계의 현실을 보여줍니다.",
          "대한민국 극지 연구의 성과와 함께, 우리가 지켜야 할 마지막 미지의 대륙인 극지의 소중함을 공유합니다.",
        ],
      },
    ],
  },
