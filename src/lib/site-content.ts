...
export const registrationSessionDays = [
  ...
  },
  {
    ...
    sessions: [
      ...
      {
        id: "youth-presentation",
        title: "청소년 프레젠테이션대회",
        time: "14:00 - 15:00",
        capacity: 150,
        description: "청소년들의 창의적인 아이디어와 미래 비전을 공유하는 프레젠테이션 경연 대회",
      },
      {
...
export const contentPages: Record<ContentSlug, ContentPage> = {
  intro: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "<세션 오프닝행사>를 시작으로 <블루카본의 잠재력과 탄소시장화 전략>, <해양풍력 특별법 시대 개막 기회와 도전·미래전략> 세션이 이어집니다.",
          "<블루카본의 잠재력과 탄소시장화 전략>: 중국 샤먼대학교의 천루전 교수와 인도 VNV 어드바이저리의 산딥 로이 초두리 대표, 비플랫 서비스 전경화 대표, 서울대학교 김종성 교수, LG전자 김영석 실장, 한국해양수산개발원 정여진 박사 등을 비롯해 국내 전문가들이 참여해 글로벌 동향과 정책 방향을 공유하며, LG전자에서 개발한 신소재가 블루카본 시장에 어떻게 적용될 수 있을지에 대한 심도 있는 논의가 진행됩니다.",
          "<해양풍력 특별법 시대 개막 기회와 도전·미래전략>: 해상풍력 특별법 시행을 계기로 국내 에너지 산업은 새로운 전환점을 맞이하고 있습니다. 본 세션에서는 제도 변화가 산업 전반에 미칠 영향을 짚어보고, 해상풍력 확대를 위한 기회와 과제를 균형 있게 살펴봅니다. 국립한국해양대학교 이영호 연구석좌교수가 좌장을 맡고, 한국풍력산업협회 최덕환 실장이 발제를 통해 정책 방향과 산업 전망을 제시합니다. 이어지는 토론에서는 각계 전문가들이 참여해 해상풍력 산업의 지속가능한 성장과 미래 전략을 심도 있게 논의할 예정입니다.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "오후에는 최가영 박사 좌장의 블루카본 패널토론과 함께 극지시민강좌가 이어지며, 시민강좌에는 김민수 한국해양수산개발원 경제전략연구본부장이 강연자로 제시되어 있습니다.",
        ],
      },
      {
        title: "6월 10일(수)",
  ...
  sketch: {
    ...
    summary:
      "2026 해양주간 행사 당일의 생생한 현장 사진과 주요 장면들을 요일별로 모아 전달해 드립니다. 뜨거웠던 현장의 열기를 사진으로 만나보세요.",
    sections: [
      {
        title: "DAY 1 - 6월 8일(월)",
        body: [
          "개회식 및 축하 공연 현장 사진이 업로드될 예정입니다.",
          "기관장 토크 콘서트 및 해양경제포럼(북극항로 세션) 진행 모습이 이곳에 게시됩니다.",
        ],
      },
      {
        title: "DAY 2 - 6월 9일(화)",
        body: [
          "블루카본 포럼의 열띤 발표와 패널 토론 현장 사진이 업로드될 예정입니다.",
          "해상풍력 특별법 시대 개막 세션의 주요 장면들을 이곳에서 확인하실 수 있습니다.",
        ],
      },
      {
        title: "DAY 3 - 6월 10일(수)",
        body: [
          "제2회 대한민국해양지도자 대상 시상식의 영광스러운 순간들이 기록됩니다.",
          "해양산업리더스 서밋 및 극지시민강좌 등 마지막 날의 생생한 사진이 업로드될 예정입니다.",
        ],
      },
    ],
  },
  ...
  qna: {
    ...
    summary:
      "2026 해양주간 행사와 관련하여 참석자분들이 자주 묻는 질문과 답변을 모아두었습니다. 추가 문의사항은 사무국으로 연락 바랍니다.",
    sections: [
      {
        title: "Q. 행사는 언제, 어디서 열리나요?",
        body: [
          "2026 해양주간은 2026년 6월 8일(월)부터 6월 10일(수)까지 3일간 진행됩니다.",
          "행사장은 부산 벡스코 2전시관 320~324호이며, 모든 주요 프로그램이 해당 장소에서 진행됩니다.",
        ],
      },
      {
        title: "Q. 사전등록은 어떻게 진행하나요?",
        body: [
          "본 홈페이지 상단의 [사전등록] 메뉴를 통해 신청하실 수 있습니다. 원하시는 참석 세션을 중복으로 자유롭게 선택하실 수 있습니다.",
          "등록 확인 및 수정이 필요하신 경우 [사전등록현황] 메뉴에서 이름과 휴대전화번호를 입력하여 언제든 정보를 수정하실 수 있습니다.",
        ],
      },
      {
        title: "Q. 행사 참가 비용이나 참가 자격 제한이 있나요?",
        body: [
          "해양주간의 모든 프로그램은 해양 산업과 미래에 관심 있는 누구나 무료로 참가하실 수 있습니다.",
          "다만, 원활한 행사장 운영 및 세션별 수용 인원 제한이 있으므로 반드시 사전에 온라인 등록을 완료해 주시기를 권장합니다.",
        ],
      },
      {
        title: "Q. 행사 관련 기타 문의는 어디로 하면 되나요?",
        body: [
          "대한민국해양지도자대상 시상 관련 접수 및 행사 전반에 대한 문의는 사무국(국제신문 문화사업국)으로 연락 부탁드립니다.",
          "• 전화 문의: 051-500-5220",
          "• 이메일 문의: kookjephoto@daum.net",
        ],
      },
    ],
  },
