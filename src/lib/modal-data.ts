...
export const scheduleModalData: Record<string, ModalContent> = {
  ...
  "blue-carbon-pm": {
    ...
    speakers: [
      ...
      },
      {
        ...
        bio: "김현성 과장은 해양수산부 해양생태과를 이끌며, 블루카본 정책과 해양 생태계 보전 정책을 담당하고 있다. 해양 생태계 보전과 탄소흡수원 확대를 위한 국가 정책 수립 및 제도 설계에 핵심적인 역할을 수행하고 있으며, 특히 염습지, 해초지, 갯벌 등 블루카본 자원의 과학적 관리와 국제 기준에 부합하는 탄소시장 연계 방안 마련에 주력하고 있다. 김 과장은 정부 부처 간 협력은 물론, 학계 및 국제기구와의 공동 연구와 정책 협의를 통해 블루카본의 경제적 가치 창출과 글로벌 탄소시장 진입 전략을 추진해 왔다. 또한 다양한 국내외 포럼과 세미나에서 발표를 통해 해양 기반 탄소중립 실현을 위한 정책 방향과 실행 전략을 제시하고 있다.",
    ...
    sections: [
      {
        ...
        isTable: true,
        content: [
          "지(地)|(사)극지해양미래포럼|대한민국 해양 발전에 기여한 지자체 및 공공기관 부문",
          "산(産)|동서콘솔(주) 이종갑 대표이사|해양 산업 현장에서 혁신과 성장을 이끈 산업계 부문",
          "학(學)|국립한국해양대학교 실습선\n  한나라호 선장 강민균, 기관장 임정훈\n  한바다호 선장 안영중, 기관장 이두형|미래 해양 인재 양성과 학술 연구에 공헌한 학계 부문",
          "연(硏)|한국해양수산개발원 김민수 본부장|해양 과학 기술 발전 및 정책 연구를 선도한 연구계 부문"
        ]
      },
      {
        title: "1. 시상부문 및 내용",
  ...
  "arctic-industry": {
    ...
    speakers: [
      ...
      },
      {
        role: "토론",
        name: "이응혁 실장",
        affiliation: ["부산항만공사", "국제물류지원실"],
        bio: "이응혁 실장은 부산항만공사에서 포트마케팅, 물류기획, 국제협력 등 지난 21년간 다양한 부서에서 실무를 쌓아온 항만물류 전문가이다. 현재 국제물류지원실 실장으로서 부산항의 글로벌 네트워크를 관리하고 국제 협력 업무를 지원하고 있다. 런던 카스경영대학원에서 해운무역금융 석사 학위를 취득하고 한국해양대학교 박사과정을 수료하는 등 실무에 학문적 깊이를 더하기 위해 노력해 왔다. 그는 UNCTAD 아프리카항만 역량강화 회의와 항만당국대표자 연례회의 등 국제 회의에서 부산항의 운영 사례를 발표하며 세계 항만들과의 교류를 이어가고 있으며, 또한 부산일보 칼럼 기고를 통해 해운항만 분야의 복잡한 현안들을 대중에게 쉽게 전달하는 소통 창구 역할을 수행하고 있다.",
        image: "/images/speakers/이응혁.jpg"
      }
    ]
  },
  ...
  "youth-presentation": {
    ...
    title: "청소년 프레젠테이션대회",
    subtitle: "Day 3 청소년 참여 프로그램",
    time: "6월 10일(수) | 14:00 ~ 15:00",
    themeColor: "amber",
    type: "text",
    body: [
      "청소년들의 창의적인 아이디어와 미래 비전을 공유하는 프레젠테이션 경연 대회입니다."
    ]
  },
    ...
    speakers: [
      {
        role: "강연",
        name: "김민수 본부장",
        affiliation: ["한국해양수산개발원", "경제전략연구본부"],
        bio: "김민수 본부장은 해양수산 분야 정책과 전략 수립을 통해 대한민국 해양수산 역량 강화를 기여해 왔다. 「북극활동진흥기본계획」, 「극지활동진흥기본계획」, 「2050 북극활동전략」, 「2050 극지비전」 등 정부가 추진하는 국가 북극기본계획 수립을 위한 연구책임을 맡아 우리나라 북극정책 기반을 조성하는데 일익을 담당했다.  「2050 신해양강국 미래비전」 연구 수행, 국가해양력 보고서 작성 등을 통해 우리나라 미래 신해양강국 정책 추진을 수립하는데 기여해 왔다. 2024년부터 현재까지 해양수산부 정책연구심의위원을 맡으면서 정부 정책연구가 실제 정책성과로 이어질 수 있도록 노력해 오고 있다.",
        image: "/images/speakers/김민수.jpg"
      }
    ]
  }
};
