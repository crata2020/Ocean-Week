  ...
  "blue-carbon-pm": {
    ...
    speakers: [
      ...
      },
      {
        ...
        name: "김남진 팀장",
        affiliation: ["LG전자"],
        bio: "김남진 팀장은 부산대학교에서 재료공학을 전공하고, 현재 LG전자 H&A 기능성소재사업실에서 기능성 유리 분말의 개발과 상용화를 담당하고 있다. 2011년 입사 이후 가전에 적용 가능한 다양한 기능성 유리 조성과 원천 소재기술 지식재산권 확보에 힘써 왔으며, 최근에는 위생과 환경 친화적 소재 연구에 주력하고 있다."
      },
      {
        role: "토론",
        name: "손승태 부장",
