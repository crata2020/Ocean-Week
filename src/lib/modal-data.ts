  ...
  "blue-carbon-pm": {
    ...
    speakers: [
      ...
      },
      {
        ...
        bio: "손승태 부장은 한국거래소에서 탄소배출권시장, 금시장, 석유시장 등 상품시장을 총괄하며 유동성 강화와 투자자 보호를 통해 국내 상품시장 발전을 이끌고 있다. 배출권시장 개설 준비와 ESG 지수 개발, 자발적 배출권시장 추진 등을 맡아 시장 안착과 글로벌 기준에 부합하는 제도 고도화에 기여해 왔다."
      },
      {
        role: "토론",
        name: "김태선 대표",
