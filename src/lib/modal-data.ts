...
export const scheduleModalData: Record<string, ModalContent> = {
  ...
  "arctic-route": {
    id: "arctic-route",
    title: "북극항로 비연안국의 권리",
    subtitle: "해양경제포럼 · 한·중·일·러 전문가 발표 및 패널 토론",
    time: "6월 8일(월) | 13:30 ~ 16:50",
    themeColor: "blue",
    type: "speakers",
    speakers: [
      {
      ...
      },
      {
        ...
        bio: "궈베이칭 교수는 중국해양대학교 국제문제 및 공공행정 분야 교수로, 중국 교육부 산하 극지센터 집행이사이자 Polar and Ocean Portal 설립자이다. 북극항로, 특히 북동·북서항로의 법적 지위와 국제정치적 의미를 중심으로 연구해 왔으며, 국제해양법과 해양정치의 관점에서 북극 질서와 협력 구조를 분석하고 있다.",
      ...
      },
      {
        ...
        bio: "김인현 교수는 국제해사기구(IMO) 규범, 해상보험, 선박금융, 북극항로와 국제물류 등 해양산업의 핵심 이슈를 연구해 왔으며, 정부·지자체·해운업계 자문 활동에도 활발히 참여하고 있다. 최근에는 북극항로 시대를 대비한 국제규범과 해양 거버넌스 논의에 꾸준히 목소리를 내며, 비연안국의 항행 자유와 국제협력의 중요성을 강조하고 있다.\n또한 대중 강연과 저술 활동을 통해 해양산업의 미래와 바다 인문학의 가치를 널리 알리고 있으며, 『선장 김인현 교수의 해운산업 깊이읽기』 시리즈 등 다양한 저서를 통해 해운·조선·물류 산업의 변화와 국제 해사 이슈를 쉽게 전달하고 있다.",
        image: "/images/speakers/김인현.jpg"
      },
      {
        role: "패널토론 · 지정 패널",
        name: "남형식 교수",
  ...
  "blue-carbon-am": {
    ...
    speakers: [
      ...
      },
      {
        ...
        bio: "산딥 로이 초두리 대표는 남아시아와 동남아시아 지역에서 기후변화 대응과 지역사회 기반 지속가능성 사업을 이끄는 사회적기업가이다. 11개국 이상에서 농촌 가구, NGO, 실행 파트너와 협력해 자연 생태계 복원과 기후 스마트 농업을 추진해 왔으며, 기후금융과 기후 솔루션 투자 분야에서도 활동하고 있다.",
      ...
      },
      {
        ...
        name: "전경화 대표",
        affiliation: ["비플랫 서비스"],
        bio: "전경화 대표는 비플랫 서비스의 설립자이자 대표로, 2018년부터 탄소 상쇄(Carbon Offset) 프로젝트 개발 및 전략 자문 분야에서 활동해 온 전문가이다. 서울을 거점으로 국내 금융기관 및 탄소배출권 할당 대상 업체들과 긴밀히 협력하며, 탄소 금융의 효율적인 활용과 실질적인 기후 임팩트를 창출하는 투자 프로젝트를 이끌고 있다. 영국 에든버러 대학교에서 탄소 금융(MSc Carbon Finance) 석사 학위를 취득하였으며, 재무 및 회계 분야에서의 다각적인 실무 경험을 바탕으로 탄소 시장에 대한 전문적인 금융 솔루션을 제시하고 있다.",
        image: "/images/speakers/전경화.jpg"
      }
    ]
  },
    ...
    speakers: [
      {
        ...
        bio: "국가녹색기술연구소(NIGT) 최가영 선임연구원은 서울대학교에서 산림환경학 박사학위를 받았다. 주로 자연기반해법(NbS)에 기반한 기술･재정･탄소시장 연계협력을 주제로, UNEP-CTCN, 세계은행, 한메콩협력기금(MKCF), 아시아산림협력기구(AFoCO) 등 다양한 국제프로젝트를 수행하였다. 국무조정실, 외교부, 과학기술정보통신부 등 정부 주요기관의 연구에 참여하고 있다.",
      ...
      },
      {
        ...
        name: "김남진 팀장",
        affiliation: ["LG전자 HS기능성소재사업실"],
        bio: "김남진 팀장은 부산대학교에서 재료공학을 전공하였으며, 현재 LG전자 HS기능성소재사업실에서 기능성 유리 분말의 개발과 상용화를 담당하고 있다. 2011년 입사 이후 다양한 기능성 유리 조성과 원천소재기술 지식재산권 확보에 힘써 왔으며, 최근에는 위생과 환경에 이로운 소재 연구에 주력하고 있다.",
    ...
    speakers: [
      {
        ...
        name: "이영호 연구석좌교수",
        affiliation: ["국립한국해양대학교"],
        bio: "이영호 연구석좌교수는 국립한국해양대학교에서 해양에너지 및 해상풍력 분야의 연구와 정책 자문을 수행해 온 전문가이다. 해양공간 활용, 해상풍력 제도 설계, 에너지 전환 전략 분야에서 축적된 연구 성과를 바탕으로 정부 및 관련 기관과의 협력 프로젝트를 이끌고 있다. 국내 해상풍력 산업 기반 마련에 기여하고 있다.",
      ...
      },
      {
        ...
        bio: "최덕환 실장은 한국풍력산업협회에서 지역 중심의 해상풍력 산업 생태계 구축과 기업 지원 활동을 주도해 온 실무 전문가이다. 해상풍력 관련 정책 대응, 산업 네트워크 구축, 신규 사업 발굴 등 다양한 현장 경험을 바탕으로 국내 해상풍력 산업의 활성화와 지역 기반 산업 경쟁력 강화에 기여하고 있다.",
      ...
      },
      {
        ...
        name: "이동준 실장",
        affiliation: ["한국남부발전"],
        bio: "이동준 실장은 한국남부발전의 해상풍력 사업을 총괄하며 대한민국 에너지 전환을 최전선에서 이끌고 있다. 중남미 시장에서 3GW규모의 IPP를 성공시킨 글로벌 프로젝트 파이낸싱 역량을 바탕으로, 현재 남부발전 최초의 해상풍력 건설사업 착공을 견인하고 있다. 대규모 자본과 기술이 집약된 해상풍력의 성공 모델을 정립하고, 공공 주도의 상생 생태계를 구축함으로써 국내 풍력 산업의 글로벌 경쟁력 강화에 기여하고 있다.",
        image: "/images/speakers/이동준.png"
      },
      {
        role: "패널",
        name: "김현도 대표",
  ...
  "ocean-awards": {
    ...
    type: "text",
    body: [
      "국립한국해양대학교와 국제신문은 국가 발전과 해양 산업의 미래를 위해 헌신해 온 숨은 일꾼들의 노력을 발굴하고, 그 업적을 널리 알리기 위해 “제 2회 대한민국 해양지도자대상”을 개최합니다.",
      "해양 분야에서 뛰어난 업적과 헌신을 보여주신 숨은 해양 영웅을 추천해주세요!",
      "해양인 여러분들의 많은 관심과 참여 바랍니다."
    ],
    sections: [
      {
      ...
      {
        title: "1. 시상부문 및 내용",
        content: ["지․산․학․연 각 부문 상패와 부상 5백만원"]
      },
      {
        title: "2. 수상자격",
      ...
      {
        title: "3. 시상식",
        content: ["2026년 6월 10일(수) 10:00 벡스코 제2전시관 321호"]
      },
      {
        title: "4. 수상자발표",
        content: ["2026년 5월 26일(월) 개별통보(예정)"]
      },
      {
        title: "5. 후보자추천",
      ...
      },
      {
        ...
        content: [
          "가. 제출서류 배부",
          "  기간 : 2026년 4월 6일(월) ~ 5월 15일(금)",
          "  국제신문 홈페이지(www.kookje.co.kr)에서 다운로드",
          "나. 제출서류접수",
          "  기간 : 2026년 4월 13일(월) ~ 5월 17일(일)",
  ...
  "arctic-industry": {
    ...
    speakers: [
      ...
      },
      {
        ...
        name: "조제형 본부장",
        affiliation: ["중소조선연구원"],
        bio: "조제형 본부장은 중소조선연구원에서 조선·해양 산업의 기술 개발과 정책 연구를 이끌어 온 전문가로, 중소형 조선소의 경쟁력 강화와 산업 생태계 발전에 기여해 왔다. 친환경 선박, 스마트 조선기술, 해양 모빌리티 등 미래 조선산업 분야와 함께 북극항로 연계 산업의 대응 전략에도 주목하고 있다."
      },
      {
        role: "토론",
        name: "이동해 센터장",
    ...
    speakers: [
      {
        ...
        name: "이동화 특임교수",
        affiliation: ["영산대학교"],
        bio: "이동화 특임교수는 영산대학교에서 극지와 해양 분야의 교육·정책·시민 소통 활동에 참여해 왔다. 북극항로 시대에 필요한 극지교육의 방향성과 미래 세대의 이해 확산을 중심으로 논의를 진행한다.",
      ...
      },
      {
        ...
        bio: "박수현 국장은 극지와 해양 분야의 공공 의제 확산과 시민 소통 활동에 참여하고 있다. 북극항로 시대의 도래와 이에 따른 교육 및 사회적 변화에 대한 폭넓은 시각을 바탕으로, 극지교육의 필요성과 방향성을 제시하며 공공적 관심과 사회적 확산의 중요성을 함께 전달하고 있다.",
        image: "/images/speakers/박수현122.jpg"
      },
      {
        role: "토론",
        name: "이은정 실장",
        affiliation: ["국제신문 논설실"],
        bio: "이은정 실장은 국제신문 논설실장으로서 국내외 주요 이슈에 대한 깊이 있는 분석과 통찰을 제시해 온 언론인이다. 정치, 경제, 환경 등 다양한 분야를 아우르는 폭넓은 시각을 바탕으로 공공 담론 형성에 기여해 왔으며, 특히 지역과 글로벌 이슈를 연결하는 균형 잡힌 논평으로 주목받고 있다. 오랜 언론 경력을 통해 축적된 전문성과 날카로운 문제의식을 바탕으로, 북극항로 시대를 둘러싼 지정학적 변화와 극지 개발, 환경 문제 등에 대해서도 심도 있는 시각을 제시할 것으로 기대된다.",
        image: "/images/speakers/이은정.jpg"
      },
      {
        role: "토론",
        name: "손용구 특임교수",
