        ...
        <article className="prose prose-lg sm:prose-xl dark:prose-invert max-w-none space-y-16">
          ...
          <div className="space-y-10 pt-8 mt-16 border-t border-slate-200 dark:border-slate-800">
            ...
            <div className="relative ml-2 sm:ml-4">
              ...
              <div className="absolute left-[-2px] top-3 bottom-8 w-1 bg-slate-200 dark:bg-slate-800 rounded-full" />
              
              {/* Day 1 */}
              <div className="relative pl-8 sm:pl-10 mb-16">
                <div className="absolute -left-[11px] top-1 h-[22px] w-[22px] rounded-full bg-sky-400 border-4 border-slate-50 dark:border-slate-950 z-10" />
                <h3 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-slate-100 mb-6 break-keep">6월 8일</h3>
                <div className="space-y-5 text-slate-700 dark:text-slate-300 leading-loose">
                  <p className="break-keep">
                    <span className="font-bold text-sky-700 dark:text-sky-400">&lt;개회식&gt;</span>을 시작으로 <span className="font-bold text-sky-700 dark:text-sky-400">&lt;기관장 토크콘서트&gt;</span>, <span className="font-bold text-sky-700 dark:text-sky-400">&lt;해양경제포럼&gt;</span>이 이어집니다.
                  </p>
                  <p className="break-keep">
